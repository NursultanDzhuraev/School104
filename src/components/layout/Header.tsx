...
export function Header({locale,entries}:{locale:Locale;entries:SearchEntry[]}) {
 const t=messages(locale);const pathname=usePathname();const [menu,setMenu]=useState(false);const [search,setSearch]=useState(false);const [query,setQuery]=useState("");
