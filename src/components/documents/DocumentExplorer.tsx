...
export function DocumentExplorer({
  ...
  return (
    <>
      <div className="filter-list" aria-label={t.documents.title}>
        <button
        ...
        {(Object.keys(t.documents.categories) as DocumentCategory[]).map(
          (key) => (
            <button
            ...
            <div className="document-body">
              ...
              <div className="actions">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label={t.documents.view + ": " + item.title[locale]}
                >
                  {t.documents.view}
                ...
                <a
                  ...
                  href={item.file}
                  download
                  aria-label={t.documents.download + ": " + item.title[locale]}
                >
