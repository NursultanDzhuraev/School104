    ...
    <>
      ...
      <section className="section" id="schedule">
        <div className="container">
          <SectionHeading
            title={t.students.schedule}
            description={t.students.scheduleNote}
          />
          <Schedule items={schedule} locale={locale} />
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <SectionHeading title={t.students.clubs} />
          <CardGrid
            items={clubs}
            locale={locale}
            icons={["book", "leaf", "users"]}
          />
        </div>
      </section>
      <section className="section muted">
        <div className="container two-columns">
          <div>
            <SectionHeading title={t.students.rules} />
          ...
          <div>
            <SectionHeading title={t.students.links} />
      ...
      <section className="section">
        <div className="container">
          <SectionHeading title={t.students.events} />
          <DateList items={events} locale={locale} />
        </div>
      </section>
    </>
  );
