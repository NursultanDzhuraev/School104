    ...
    <>
      ...
      <section className="section">
        <div className="container">
          {gallery.some((item) => item.demo) && (
            <p className="sample-note">{t.common.photoNote}</p>
          )}
          <GalleryExplorer items={gallery} locale={locale} />
          <div className="section-gap">
            <SectionHeading title={t.gallery.videos} />
            {videos.length ? (
